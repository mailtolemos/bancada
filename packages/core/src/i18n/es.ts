...
export const es: Dictionary = {
  ...
  match: {
    teamNews: "Noticias de los equipos",
  ...
  profile: {
    title: "Mi perfil",
    subtitle: "Elige los clubes que sigues y tus competiciones favoritas.",
    myClubsSection: "Clubes que sigo",
    leaguesSection: "Competiciones favoritas",
    addClub: "Añadir club",
    pickCompetition: "Elige la competición",
    searchClub: "Buscar club…",
    following: "Siguiendo",
    follow: "Seguir",
    noClubs: "Aún no sigues ningún club. Elige uno abajo.",
    leaguesHint: "Las competiciones favoritas aparecen primero en la navegación.",
    savedLocally: "Guardado en este dispositivo. Inicia sesión para sincronizar.",
    savedAccount: "Guardado en tu cuenta y sincronizado.",
    primary: "Principal",
